...
public class BlockPipe extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemInHand)
    {
        if (world.getTileEntity(x, y, z) != null)
        {
            ...
            ((TileEntityPipe) world.getTileEntity(x, y, z)).direction = (rot == 0 ? ForgeDirection.SOUTH : rot == 1 ? ForgeDirection.WEST : rot == 2 ? ForgeDirection.NORTH : ForgeDirection.EAST);
        }
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        if (player.getHeldItem() != null)
        {
            ...
            tileEntityPipe.addItem(new ItemStackPipeObject(player.getHeldItem(), 0f));
        }
